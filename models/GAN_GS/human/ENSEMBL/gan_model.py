...
class GAN(object):
    ...
    def __init__(self, config: dict, device: torch.device):
        ...
        # Optimizers
        self.optim_disc = optim.Adam(self.D.parameters(), lr=self.lr_d, betas=(0.5, 0.999))
        self.optim_gen = optim.Adam(self.G.parameters(), lr=self.lr_g, betas=(0.5, 0.999))
    ...
    def train(self, 
        ...
        for epoch in range(epochs):
            ...
            # Load batches
            for geno, _, _ in TrainDataLoader:                
